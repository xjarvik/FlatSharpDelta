...
{
    static class PrimitiveListTypesCodeWriter
    {
        public static string WriteCode(string _namespace)
        {
            return $@"
                using System;
                ...
                {GetPrimitiveListType(_namespace, "ByteList", "System.SByte", "ByteListDelta", "0")}
                {GetPrimitiveListType(_namespace, "UByteList", "System.Byte", "UByteListDelta", "0")}
                {GetPrimitiveListType(_namespace, "BoolList", "System.Boolean", "BoolListDelta", "false")}
                {GetPrimitiveListType(_namespace, "ShortList", "System.Int16", "ShortListDelta", "0")}
                {GetPrimitiveListType(_namespace, "UShortList", "System.UInt16", "UShortListDelta", "0")}
                {GetPrimitiveListType(_namespace, "IntList", "System.Int32", "IntListDelta", "0")}
                {GetPrimitiveListType(_namespace, "UIntList", "System.UInt32", "UIntListDelta", "0u")}
                {GetPrimitiveListType(_namespace, "FloatList", "System.Single", "FloatListDelta", "0f")}
                {GetPrimitiveListType(_namespace, "LongList", "System.Int64", "LongListDelta", "0L")}
                {GetPrimitiveListType(_namespace, "ULongList", "System.UInt64", "ULongListDelta", "0uL")}
                {GetPrimitiveListType(_namespace, "DoubleList", "System.Double", "DoubleListDelta", "0d")}
                {GetPrimitiveListType(_namespace, "StringList", "System.String", "StringListDelta", "null")}
            ";
        }

        private static string GetPrimitiveListType
        (
            string _namespace,
            string listName,
            string T,
            ...
            return $@"
                namespace {_namespace} {{
                    using T = {T};
                    using TListDelta = {_namespace}.{TListDelta};
